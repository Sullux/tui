...
const Tui = (options = {}) => {
  ...
  const start = () => {
    ...
    // Automatically focus the first focusable component if autoFocus is not disabled
    if (!tuiState.focusedId && options.autoFocus !== false && initialAppState.focusedId === undefined) {
